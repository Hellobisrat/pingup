import { ArrowLeft, SolarPanelIcon, Sparkle, TextIcon, Upload } from 'lucide-react'
...
const StoryModal = ({setShowModal,fetchStories}) => {
  ...
  return (
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur-md
     ...
     <div className='w-full max-w-md'>
        ...
        <div className='rounded-lg h-96 flex items-center justify-center relative' style={{backgroundColor:background}}>
          {mode ==='text' && (
            ...
            placeholder="what is in your mind?" onChange={(e)=>setText(e.target.value)}
            value={text}/>
          )}
          {
        ...
        <div className='flex mt-4 gap-2'> 
            ...
            <button onClick={()=>{setMode('text'); setMedia(null); setPreviewUrl(null) }} className={`flex-1 flex items-center justify-center gap-2 p-2
             cursor-pointer rounded ${mode ==='text' ?'bg-white text-black' :
              "bg-zinc-800"
            }`} >
              <TextIcon/> Text
            </button>
