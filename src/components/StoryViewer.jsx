...
const StoryViewer = ({viewStory, setViewStory}) => {
  ...
  return (
    <div className='fixed inset-0 h-screen bg-black bg-opacity-0 z-50
    ...
    style={{backgroundColor: viewStory.media_type==='text'?viewStory.background_color:'#000000'}}>
      ...
      <div className='absolute top-0 left-0 w-full h-1 bg-gray-700'>
       ...
       className='size-7 sm:size-8 rounded-full object-cover border border-x-white'/>
      ...
      <div className='min-w-[90vw] min-h-[90vh] flex items-center justify-center'>
        {reanderContent()}
      </div>
      </div>
  )
